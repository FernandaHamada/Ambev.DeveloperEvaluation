...
public class User : BaseEntity, IUser
{
    ...
    /// Must not be null or empty and should contain address.
    /// </summary>
...
{
    /// <summary>
    /// Gets the user's city address.
    /// Must not be null or empty and should contain city address.
    /// </summary>
    public string City { get; set; } = string.Empty;

    /// <summary>
    /// Gets the user's street address.
    /// Must not be null or empty and should contain street address.
    /// </summary>
    public string Street { get; set; } = string.Empty;

    /// <summary>
    /// Gets the user's number address.
    /// Must not be null and should contain number address.
    /// </summary>
    public int Number { get; set; }

    /// <summary>
    /// Gets the user's zip code address.
    /// Must not be null or empty and should contain zip code address.
    /// </summary>
    public string ZipCode { get; set; } = string.Empty;

    /// <summary>
    /// Gets the user's geolocation.
    /// Must not be null or empty and should contain geolocation.
    /// </summary>
...
{
    /// <summary>
    /// Gets the user's latitude geolocation.
    /// Must not be null or empty and should contain latitude geolocation.
    /// </summary>
    public string Lat { get; set; } = string.Empty;

    /// <summary>
    /// Gets the user's longitude geolocation.
    /// Must not be null or empty and should contain longitude geolocation.
    /// </summary>
